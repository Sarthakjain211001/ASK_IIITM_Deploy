      ...
      <div className="container fontlink2">
        <div className="blog-post mb-4">
          ...
          <p className="blog-post-meta">
            January 1, 2014 by{" "}
            <a href="#">{blog && blog.postedBy && blog.postedBy.name}</a>
          </p>
          {blog && blog.body}
          <br />
          { blog&&blog.likes.includes(state._id)?(
             <button type="button" class="btn btn-danger m-1" onClick={()=>{unlikePost(blog._id)}}>
             <svg
            ...
            <button type="button" className="btn btn-primary m-1" onClick={()=>{likePost(blog._id)}}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
          ...
          <div className="container " style={{ "margin": "0 auto", "width": "55%" }}>
            ...
            <form onSubmit={(e)=>{
              ...
              makeComment(e.target[0].value,blog._id)
              }}>
...
<div class="card">
          <div class="card-body">
            ...
            <p>Author : {comment.postedBy.name}</p>
          </div>
        </div>
              )
            })}
          {/* <Write_a_comment/> */}
          <div>{props.writeacommentonblog}</div>
          {/* <Comments_for_an_answer/>  */}
          <div>{props.blogcomments}</div>
        </div>
      </div>
    </div>
  );
